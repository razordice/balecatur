         ...
         <form role="form" action="proses.php?act=addBerita" method="post" id="add-news" enctype="multipart/form-data">
   		...
   		<table class="table">
            ...
            <td><?php echo $no;?></td>
						...
						<td>
							<a href="<?php echo "homeadmin.php?modul=man_berita_edit&id=$result[id_berita]"?>">
								<i class="fa fa-edit"></i> Edit
							</a> | 
							<a href="<?php echo "proses.php?act=hapusBerita&id=$result[id_berita]";?>" onclick="return confirm('Delete?');">
